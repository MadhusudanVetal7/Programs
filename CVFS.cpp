...
void man(char *name)
{
    ...
    else if (strcmp(name,"write") == 0)
    {
        ...
        printf("Usage : write File_name\n After the data that we want to write\n");
    }
    ...
    else if(strcmp(name,"start") == 0)
    {
        ...
        printf("Usage : start File_name\n");
    }
    else if(strcmp(name,"fstart") == 0)
    {
        printf("Description : Used to display information of files\n");
        printf("Usage : start File_Description\n");
    }
    ...
    {
        printf("Description : Used to delete the files\n");
...
void DisplayHelp()
{
    ...
    printf("read : to read the consept from the file\n");
    printf("write : to write console into the file\n");
    printf("exit : To terminate file system\n");
    printf("start : To Display information of using name\n");
    printf("fstart : To Display information of using descriptor\n");
...
int rm_File(char *name)
{
    ...
    if(UFDTArr[fd].ptrfiletable->ptrinode->LinkCount == 0)
    {
        ...
        //free(UFDTArr[fd].ptrfiletable->ptrnode->Buffer);
    ...
    while(1)
    {
        ...
        count = sscanf(str,"%s%s%s%s",command[0],command[1],command[2],command[3]);
            ...
            else if(count == 4)
            {
                ...
                {
                    printf("ERROR : Command nor Found!!!\n");
                    continue;
                }
            }
            else
